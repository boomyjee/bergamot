(function(){
    ...
    var queue = teacss.queue = (function(){function a(a){function l(){if(g&&d<a){var b=g,c=b[0],f=Array.prototype.slice.call(b,1),m=b.index;g===h?g=h=null:g=g.next,++d,f.push(function(a,b){--d;if(i)return;a?e&&k(i=a,e=j=g=h=null):(j[m]=b,--e?l():k(null,j))}),c.apply(null,f)}}var c={},d=0,e=0,f=-1,g,h,i=null,j=[],k=b;return arguments.length<1&&(a=Infinity),c.defer=function(){if(!i){var a=arguments;a.index=++f,h?(h.next=a,h=h.next):g=h=a,++e,l()}return c},c.await=function(a){return k=a,e||k(i,j),c},c}function b(){}return a;})();
            ...
            if (val && val.constructor && val.call && val.apply) {
                ...
                if ((idx=s.indexOf(":"))!=-1) {
                    ...
                    if (this.aliases && idx && this.aliases[subkey] && modifiers!="!") {
                        (typeof window=='undefined' ? global : window)[this.aliases[subkey]](trim(s.substring(idx+1)));
                        return;
                    }
                }
                if (this.current)
    ...
    teacss.getFullPath = function(path,base,allowNoExt) {
        base = (base===undefined) ? (typeof location=='undefined' ? '/':location.href):base;
        if (!(path[0]=='/' ||
            path.indexOf("http://")==0 ||
    ...
    if (module && module.exports) module.exports = teacss; else window.teacss = teacss;
})();